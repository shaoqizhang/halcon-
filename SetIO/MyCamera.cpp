...
int     CMyCamera::GetEnumValue(IN const char* strKey, OUT MVCC_ENUMVALUE *stValue)
{
    if (NULL == strKey)
    {
        return MV_E_PARAMETER;
    ...
    memset(stValue, 0, sizeof(MVCC_ENUMVALUE));
    return MV_CC_GetEnumValue(m_hDevHandle, strKey, stValue);
}
